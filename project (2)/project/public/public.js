  ...
  orderList?.forEach((item) => {
    basket.insertAdjacentHTML(
      ...
      `
        ...
        <p><span onclick="changeCount(${item.id},'encrease')"><span class="material-symbols-outlined">
        add_circle
        </span></span>
        <span onclick="changeCount(${item.id},'decrease')"><span class="material-symbols-outlined">
        do_not_disturb_on
        </span></span>
        <span onclick='remove(${item.id})'><span class="material-symbols-outlined">
        delete
        </span></span></p>
        </section>
        `
